...
export default function Finances() {
  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl border border-warm-300/80 bg-white/90 p-5 shadow-warm dark:border-warm-800/80 dark:bg-warm-900/85 sm:p-6">
