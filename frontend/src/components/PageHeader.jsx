  ...
  return (
    <div className={clsx("flex flex-col justify-between gap-4 xl:flex-row xl:items-end", className)}>
      <div className="min-w-0">
        ...
        <h1 className="mt-1 text-3xl font-semibold tracking-tight text-slate-950 dark:text-slate-100 sm:text-4xl">{title}</h1>
        {description && <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500 dark:text-slate-400 sm:text-base">{description}</p>}
      </div>
