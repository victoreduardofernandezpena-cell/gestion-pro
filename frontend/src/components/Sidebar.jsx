...
const items = [
  ...
  { label: "Reportes", path: "/reportes", icon: BarChart3, roles: ["admin", "ventas", "almacen", "contabilidad"] },
  ...
  { label: "Cuentas por Pagar", path: "/accounts-payable", icon: HandCoins, roles: ["admin", "almacen", "contabilidad"] },
  ...
  { label: "Fidelizacion", path: "/fidelizacion", icon: BadgeDollarSign, roles: ["admin", "ventas", "contabilidad"] },
